...
class FilamentNotesAndAnnouncementPlugin implements Plugin
{
    ...
    {
        return FilamentNotesAndAnnouncementServiceProvider::$name;
    }
    ...
    public function register(Panel $panel): void
    {
        $panel->discoverResources(
            ...
            for: 'CWSPS154\\FilamentNotesAndAnnouncement\\Filament\\Resources'
        );
    }
